...
export default function DandyChair()  {
      ...
      <main>
           <div className="px-4 md:px-8 lg:px-12 py-8 md:py-12">
            ...
            <div className="w-full md:w-1/2 h-auto">
                <img  className="w-full h-auto object-cover" src={'Photo (4).png'} height={800} width={800}
                alt="chair"
                data-aos="fade-right"
            ...
            <div className="w-full md:w-1/2 px-4 md:px-10 py-6 flex flex-col justify-center">
              <div>
                <p className="text-xl md:text-2xl font-semibold">The Chair</p>
